...
- [ ] `mise run dev` browsed at `http://share.localhost:5174` shows the authenticated library with real items; `mise run preview` serves the built SPA through FastAPI.
